<template>
  <b-container>
    <h1 v-t="ability ? 'abilities.editTitle' : 'abilities.newTitle'" />
    <status-detail v-if="ability" :model="ability" />
    <validation-observer ref="form">
      <b-form @submit.prevent="submit">
        <div class="my-2">
          <icon-submit v-if="ability" :disabled="!hasChanges || loading" icon="save" :loading="loading" text="actions.save" variant="primary" />
