...
internal class ReplaceItemValidator : AbstractValidator<ReplaceItemPayload>
{
  public ReplaceItemValidator(IUniqueNameSettings uniqueNameSettings, ItemCategory category)
  {
