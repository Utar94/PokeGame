...
namespace PokeGame.Application.Species
{
  public interface ISpeciesQuerier
  {
    ...
    Task<SpeciesModel?> GetAsync(Guid regionId, int number, CancellationToken cancellationToken = default);
    ...
    Task<ListModel<SpeciesModel>> GetPagedAsync(Guid? regionId = null, string? search = null, PokemonType? type = null,
