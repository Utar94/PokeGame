...
namespace PokeGame.Infrastructure.Migrations
{
    ...
    [Migration("20220903051404_CreateInventoryTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokeGame.Core.Inventories.Inventory", b =>
                {
            ...
            modelBuilder.Entity("PokeGame.Core.Items.Item", b =>
                {
                    b.Property<int>("Sid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PokeGame.Core.Trainers.Trainer", b =>
                {
                    b.Property<int>("Sid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PokeGame.Core.Inventories.Inventory", b =>
                {
                    b.HasOne("PokeGame.Core.Items.Item", "Item")
                        .WithMany("Inventory")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PokeGame.Core.Trainers.Trainer", "Trainer")
                        .WithMany("Inventory")
