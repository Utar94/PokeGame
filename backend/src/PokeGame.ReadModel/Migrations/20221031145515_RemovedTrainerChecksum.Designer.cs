...
namespace PokeGame.ReadModel.Migrations
{
    ...
    [Migration("20221031145515_RemovedTrainerChecksum")]
    partial class RemovedTrainerChecksum
    {
            ...
            modelBuilder.Entity("PokeGame.ReadModel.Entities.TrainerEntity", b =>
                {
                    ...
                    b.HasIndex("LegacyRegion", "Number", "Name")
                        .IsUnique();
