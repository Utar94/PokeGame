...
{
  internal class MoveConfiguration : EntityConfiguration<Move>, IEntityTypeConfiguration<Move>
  {
    public override void Configure(EntityTypeBuilder<Move> builder)
    {
      ...
      builder.Property(x => x.Category).HasDefaultValue(default(Domain.Moves.MoveCategory));
