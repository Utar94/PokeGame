...
{
  private const string ConfigurationKey = "SQLCONNSTR_Pokemon";
  ...
  public static IServiceCollection AddPokeGameWithEntityFrameworkCoreSqlServer(this IServiceCollection services, string connectionString)
  {
    return services
      ...
      .AddDbContext<PokemonContext>(options => options.UseSqlServer(connectionString, b => b.MigrationsAssembly("PokeGame.EntityFrameworkCore.SqlServer")))
