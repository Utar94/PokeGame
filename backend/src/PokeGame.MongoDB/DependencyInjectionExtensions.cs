...
public static class DependencyInjectionExtensions
{
  public static IServiceCollection AddPokeGameWithMongoDB(this IServiceCollection services, IConfiguration configuration)
  {
    ...
    return services.AddPokeGameWithMongoDB(settings);
  }
  public static IServiceCollection AddPokeGameWithMongoDB(this IServiceCollection services, MongoDBSettings settings)
  {
