...
public interface IPokemonClient
{
  ...
  Task<Item> CreateItemAsync(CreateItemPayload payload, CancellationToken cancellationToken = default);
  ...
  Task<Item?> ReplaceItemAsync(Guid id, ReplaceItemPayload payload, long? version = null, CancellationToken cancellationToken = default);
  ...
  Task<SearchResults<Item>> SearchItemsAsync(SearchItemsPayload payload, CancellationToken cancellationToken = default);
